...
def create_ui(txt2img, img2img, run_extras, run_pnginfo):
    ...
    def UpdateWebui():
        ...
        updateui = os.system('cp stable-diffusion-webui/update.sh . && systemd-run --machine=@.host --user --scope --slice=updatewebui ./update.sh $(cat stable-diffusion-webui/target) > stable-diffusion-webui/update.log 2>&1')
        return updateui
